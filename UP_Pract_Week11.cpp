...
//    }
//}
//int sumOfNumbersOnEvenPossitions(int*ptr, int n) {
//    int sum = 0;
//    int index = 0;
//    fillArr(ptr, n);
//    while (index < n) {
...
//    return sum;
//}
//void fillArrEvenInTheBeginning(int* ptr, int n) {
//    int numb;
//    int index = 0;
//    while (index < n) {
//        cin >> numb;
...
//    cin >> n;
//    int* ptr = new int[n];
//    fillArrEvenInTheBeginning(ptr, n);
//    for (int i = 0; i < n; i++) {
//        cout << ptr[i] << " ";
//    }
//    delete[]ptr;
//}
//
////Задача 1: От стандартния вход се чете естествено число n. След това се четат n цели числа и се записват в едномерен масив. Да се изведе сбора на числата на четни позиции.
////Задача 2: От стандартния вход се чете число n и се създава масив от n цели числа. След това от стандартния вход се въвеждат n цели числа като числата на четни позиции 
////се записват в първата половина на масива а тези на нечетни във втората.
//
//
/**
*
